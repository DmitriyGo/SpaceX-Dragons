                ...
                {!isLoading ? <div className={cl.wrapper}>
                    ...
                    <div className={cl.table}>
                        ...
                        <div className={cl.tableRow}>
                            ...
                            <div className={cl.tableCol}>{dragons[0]?.orbit_duration_yr} years</div>
                        </div>
                        <div className={cl.tableRow}>
                            <div className={cl.tableCol}>CREW CAPACITY</div>
                            <div className={cl.tableCol}>{dragons[0]?.crew_capacity}</div>
                        </div>
                        <div className={cl.tableTitle}>
                            HEAT SHIELD
                        </div>
                        <div className={cl.tableRow}>
                            ...
                            <div className={cl.tableCol}>{dragons[0]?.heat_shield.material}</div>
                        </div>
                        <div className={cl.tableRow}>
                            <div className={cl.tableCol}>HEAT SHIELD TEMP</div>
                            <div className={cl.tableCol}>{dragons[0]?.heat_shield.temp_degrees} °C</div>
                        </div>
                        <div className={cl.tableRow}>
                            <div className={cl.tableCol}>HEAT SHIELD SIZE</div>
                            <div className={cl.tableCol}>{dragons[0]?.heat_shield.size_meters}m</div>
                        </div>
                        <div className={cl.tableTitle}>
                            THRUSTERS
                        </div>
                        <div className={cl.tableRow}>
                            ...
                            <div className={cl.tableCol}>{dragons[0]?.thrusters[0].type}</div>
                        </div>
                        <div className={cl.tableRow}>
                            <div className={cl.tableCol}>AMOUNT</div>
                            <div className={cl.tableCol}>{dragons[0]?.thrusters[0].amount}</div>
                        </div>
                        <div className={cl.tableRow}>
                            <div className={cl.tableCol}>FUEL 1</div>
                            <div className={cl.tableCol}>{dragons[0]?.thrusters[0].fuel_1}</div>
                        </div>
                        <div className={cl.tableRow}>
                            <div className={cl.tableCol}>FUEL 2</div>
                            <div className={cl.tableCol}>{dragons[0]?.thrusters[0].fuel_2}</div>
                        </div>
                    </div>
                </div> : <Spinner/>}
            </Container>
